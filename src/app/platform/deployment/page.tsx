            ...
            <div className="space-y-12">
              {steps.map((step, index) => (
                <div key={index} className="flex flex-col md:flex-row gap-8 relative group">
                  ...
                  <div className="w-20 h-20 rounded-2xl bg-black/5 flex items-center justify-center shrink-0 border border-black/10 group-hover:bg-black/10 transition-colors">
                    <step.icon className="w-10 h-10 text-black" />
                  </div>
                  <div className="flex-1">
                    <div className="inline-block px-3 py-1 rounded-full bg-black/5 border border-black/10 text-black text-xs font-bold mb-3 uppercase tracking-wider">
                      {step.day}
                    </div>
