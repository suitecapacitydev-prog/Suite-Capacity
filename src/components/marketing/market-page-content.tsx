...
import { MapPin, TrendingUp, Users, ShieldCheck, Zap, Star, Calendar, Sun, Waves, LucideIcon } from 'lucide-react';
    ...
    <SiteShell>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-[10px] font-black uppercase tracking-[0.2em] mb-6 border border-primary/20">
                <MapPin className="w-3 h-3" /> {marketName}
              </div>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="absolute -bottom-8 -left-8 glass-panel p-8 border-black/5 bg-white shadow-xl max-w-xs animate-in slide-in-from-bottom-5 duration-700 z-20">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="text-2xl font-black tracking-tight">{revenueIncrease}</div>
                </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16">
            <h2 className="text-4xl font-black tracking-tight mb-6">{featuresTitle} <span className="text-primary">{featuresHighlight}</span></h2>
      ...
      <section className="py-24 bg-primary/5 border-t border-black/5">
        <div className="container mx-auto px-6 max-w-4xl text-center">
            <h2 className="text-3xl font-black mb-10 tracking-tight">The {marketName} Management Standard</h2>
            <div className="space-y-6 text-black/70 font-medium leading-relaxed">
                <p>
                    Managing a short-term rental in {marketName} requires more than just a cleaning crew. It requires an integrated approach to dynamic pricing, guest vetting, and high-frequency maintenance. Our platform was built specifically to handle the complexities of the {marketName} market.
                </p>
                <p>
