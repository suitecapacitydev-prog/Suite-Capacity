  ...
  return (
    <div className="glass-panel p-6 flex flex-col h-full hover:border-white/20 transition-colors">
      <div className="flex justify-between items-start mb-4">
        <div className="p-2 bg-primary/5 rounded-lg border border-black/5">
          {icon}
        </div>
        {trend && (
          <div className={`px-2 py-1 text-xs font-medium rounded-full ${trendUp ? 'bg-primary/10 text-black border border-black/20' : 'bg-destructive/10 text-destructive border border-destructive/20'
            }`}>
            {trend}
          </div>
        )}
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="p-2 border border-black/30 bg-primary/10 rounded-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
        <div className="lg:col-span-2 glass-panel p-6">
          ...
          <div className="h-64 flex items-center justify-center border border-black/5 bg-primary/5 rounded-lg">
